...
gauge = {
{
    ...
    graph_fg_colour=0x77B753,      graph_fg_alpha=0.7,
...
{
    name='freq',           arg='11',                     max_value=100,
    x=70,                          y=540,
    graph_radius=56,
    graph_thickness=2,
    graph_start_angle=180,
    ...
    graduation_fg_colour=0xFFFFFF, graduation_fg_alpha=0.3,
    caption='  11',
    caption_weight=1,              caption_size=4.0,
    caption_fg_colour=0xFFFFFF,    caption_fg_alpha=0.7,
},
{
    name='freq',           arg='10',                     max_value=100,
    x=70,                          y=540,
    graph_radius=52,
    graph_thickness=2,
    graph_start_angle=180,
...
},
{
    ...
    graph_unit_angle=2.7,          graph_unit_thickness=2.7,
    graph_bg_colour=0xffffff,      graph_bg_alpha=0.1,
    graph_fg_colour=0xFF5C2B,      graph_fg_alpha=0.7,
    hand_fg_colour=0x77B753,       hand_fg_alpha=0.7,
    txt_radius=64,
    txt_weight=0,                  txt_size=9.0,
    txt_fg_colour=0xEF5A29,        txt_fg_alpha=1.0,
    graduation_radius=28,
